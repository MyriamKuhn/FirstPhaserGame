class TilesManager {
    ...
    createVictoryOrb(x, y){
        let victoryOrb = this.scene.physics.add.staticSprite(x*32, y*32+8, "tiles", 3);
        victoryOrb.setDisplaySize(16, 16);
        victoryOrb.body.setSize(16, 16);
        victoryOrb.body.x +=8;
        victoryOrb.body.y +=8;
        victoryOrb.setInteractive();
        return victoryOrb;
    }
}