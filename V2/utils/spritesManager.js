class SpritesManager {
    ...
    loadSprites(){
        ...
        this.scene.load.image('bg', 'assets/images/bg/background.png');
        this.scene.load.image('volume-on', 'assets/images/icons/volume-on.png');
        this.scene.load.image('volume-off', 'assets/images/icons/volume-off.png');
    ...
    createDinosaur(x, y, color){ 
        ...
        dinosaur.body.onWorldBounds = true;
