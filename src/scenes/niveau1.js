class Niveau1 extends Phaser.Scene {
    ...
    create(){
        ...
        this.tilesManager.createPlatform(1, 31, 49, 31, this.levelType); // BOTTOM PLATFORM
        ...
        this.spritesManager.createCoin(49, 6);
        this.spritesManager.createCoin(49, 7);
        this.spritesManager.createCoin(49, 8);
        this.spritesManager.createCoin(48, 6);
        this.spritesManager.createCoin(48, 7);
        this.spritesManager.createCoin(48, 8);
        this.spritesManager.createCoin(47, 6);
        this.spritesManager.createCoin(47, 7);
        this.spritesManager.createCoin(47, 8);
        this.spritesManager.createCoin(46, 6);
        ...
        this.physics.add.overlap(this.dinosaurs, this.coins, (player, coin) => {this.collectCoin(player, coin);});
